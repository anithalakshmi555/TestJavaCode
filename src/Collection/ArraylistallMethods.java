...
public class ArraylistallMethods {
	...
	//	System.out.println("-----void replaceAll(collection c)  it is used to replace  all the elments of the list with the  specified collection  ---------");
		...
		System.out.println("-----Maximum elem in the array---------");
		System.out.println(Collections.max(al));
		System.out.println("-----Minimum elem in the array---------");
		System.out.println(Collections.min(al));
		
		
		System.out.println("-----priniting the contents in the reveres way---------");
